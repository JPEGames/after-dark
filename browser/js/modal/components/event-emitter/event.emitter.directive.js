  ...
  return {
    ...
    link: function (scope) {
      ...
      scope.exitMessage = function (aMessage) {
        ModalFactory.submitResponse(0, aMessage.socketMsg)
      ...
      scope.confirmMessage = function (aMessage) {
        ...
        ModalFactory.submitResponse(1, aMessage.socketMsg)
        ModalFactory.markRead(aMessage)
        nextModal(aMessage)
      }
      ...
      scope.submitAnswer = function (aMessage, aResponse) {
        ...
        ModalFactory.submitResponse(aResponse, aMessage.socketMsg)
        ModalFactory.markRead(aMessage)
        nextModal(aMessage)
      }
    }
