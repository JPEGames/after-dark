  ...
  return {
    ...
    link: function (scope) {
      ...
      scope.exitMessage = function (aMessage) {
        ModalFactory.submitResponse(0, aMessage.socketMsg, aMessage.category)
      ...
      scope.confirmMessage = function (aMessage) {
        ...
        ModalFactory.submitResponse(1, aMessage.socketMsg, aMessage.category)
        ModalFactory.markRead(aMessage)
        nextModal(aMessage)
      }
      ...
      scope.submitAnswer = function (aMessage, aResponse) {
        ...
        ModalFactory.submitResponse(aResponse, aMessage.socketMsg, aMessage.category)
        ModalFactory.markRead(aMessage)
        nextModal(aMessage)
      }
    }
